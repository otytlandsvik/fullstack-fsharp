...
//---------------------------------------------------------------- Functions --------------------------------------------------------------------------------
    ...
    static member inline useToastController (toasterId: string option): ToastController =
        ...
        let updateToast props =
            let props: IUpdateToastOptionsProp list = !!props |> createObj |> unbox
            props |> controller.updateToast

        {
            dispatchToast = fun props -> dispatchToast props
            dismissToast = fun props -> controller.dismissToast props
            dismissAllToasts = fun props -> controller.dismissAllToasts props
            updateToast = fun props -> updateToast props
